...
exports.handler = async function (event, context) {
  ...
  const dataCleaners = process.env.DATA_CLEANERS;
  ...
  // const cleanerCb = event.cleanerCb;
  // console.log("(+) typeof cleanerCb: \n" + (typeof cleanerCb));

  // const websiteDetails = event.websiteDetails;
  ...
  try {
    ...
    // return {
    //   statusCode: 200,
    //   payload: "'scrape-website-action' successfully completed"
    // };
